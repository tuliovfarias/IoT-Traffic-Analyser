...
#    string= "SELECT * FROM db_test.mac_count WHERE datetime >= '"+ str(start_time) +"' and datetime < '"+ str(end_time_temp)+"'"
    query1= "SELECT IFNULL (SUM(count),0) FROM db_test.mac_count WHERE datetime >= '"+ str(start_time) +"' and datetime < '"+ str(end_time_temp)+"'"
    query2= "SELECT IFNULL (COUNT(MAC),0) FROM db_test.mac_count WHERE datetime >= '"+ str(start_time) +"' and datetime < '"+ str(end_time_temp)+"'"
